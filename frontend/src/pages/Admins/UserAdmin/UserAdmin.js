...
const UserAdmin = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (item) => {
                return (
                    <>
                        <Link to={`/admin/admins/edit/${item.id}`}>
                        ...
                        <Link to={`/admin/admins/detail/${item.id}`}>
    ...
    return (
        <>
            <TopPage title="Quản lý tài khoản" />
            <div className="my-3">
                {profile.role === "employee" ? (
                    ""
                ) : (
            ...
            <h5 className="text-uppercase text-center mb-3">danh sách tài khoản</h5>
